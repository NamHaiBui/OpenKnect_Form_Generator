...
library form_field_appearance;

import 'package:flutter/material.dart';

//{type: Size, quatrics: List<int>}
const Size titleTextSize = Size(166, 52); // List<Int>
const Size addressTitleTextSize = Size(166, 146); // List<Int>
const Size formTextFieldSize = Size(432, 52); // List<Int>
const Size formDropdownFieldSize = Size(100, 52); // List<Int>
const Size formRangeFieldSize = Size(195, 52); // List<Int>
const Size formRadioOptionSize = Size(150, 0); // List<Int>
const double formRadioWrapSpacing = 10.0; // double
//{type: EdgeInsets, quatrics: List<int>}
const EdgeInsets paddingPostingStatusTitles =
    EdgeInsets.only(left: 56, right: 24, bottom: 16, top: 16);
const EdgeInsets paddingBetweenFormFields = EdgeInsets.only(bottom: 24);
...
// {type:SizedBox, quatrics: List<int>}
...
const Size formAddressStateFieldSize = Size(100, 44);
